...
public class CountDownLatchDemo {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		Worker Fifth = new Worker(2000, latch, "WORKER-5");
		Worker six   = new Worker(2000, latch, "WORKER-6");
		Worker seven = new Worker(2000, latch, "WORKER-7");
		Worker eight = new Worker(2000, latch, "WORKER-8");
